...
import com.example.lenovo.addcar.adapter.ShopAdapter;
import com.example.lenovo.addcar.bean.WuBean;
import com.example.lenovo.addcar.presenter.WuPresenter;
...
public class FragmentGwc extends Fragment implements IWuView{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = View.inflate(getActivity(), R.layout.fragm_gwc,null);
        //找控件
