package com.example.lenovo.addcar.bean;
...
public class WuBean {
    ...
    public static class DataBean {
        ...
        public static class ListBean {
            ...
            public ListBean(int isFirst, boolean shopSelected, boolean itemSelected) {
